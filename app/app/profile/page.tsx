      ...
      {profile.membership_tier === 'free' && (
        <div className="rounded-3xl border border-dashed border-border bg-card p-5 text-center">
          ...
          <p className="mt-1 text-sm text-muted-foreground text-pretty">
            all four programs, Watch, recipes and meal plans, every workout, Freedom, and posting in the Circle.
          </p>
          <Link
            href="/app/membership"
      ...
      <ClosetShelf
        ...
        items={[
          ...
          */
          ...
          { href: '/app/promises', label: 'Promises', icon: CalendarDays, note: 'and experiments' },
        ]}
      />
